export const siteContent = {
  ...
  research: {
    ...
    description:
      "DeepPrior promotes reproducible and impactful research in energy markets and power systems through prior-informed AI for real-world decision-making.",
    papers: [
      {
  ...
  analysis: {
    ...
    description:
      "DeepPrior provides weekly energy insights to deliver timely and actionable signals across electricity markets and power systems.",
    posts: [
      {
        date: "11 Apr 2026",
        country: "Germany",
